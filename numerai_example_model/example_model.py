...
def main():
    ...
    training_data = read_csv("numerai_example_model/numerai_training_data.csv")
    # The tournament data is the data that Numerai uses to evaluate your model.
    tournament_data = read_csv("numerai_example_model/numerai_tournament_data.csv")
    ...
    model = lgb.lgb.LightGBMRegressor(max_depth=5, learning_rate=0.1, n_estimators=200, n_jobs=-1, colsample_bytree=0.1)
